...
fun StudentsGridScreen(
    ...
    LazyVerticalGrid(
        ...
        items(items = students, key = { student -> student.id }) {
                student ->
            StudentCard(
                student,
                modifier = modifier
...
fun StudentCard(student: Student, modifier: Modifier = Modifier) {
    Card(
        ...
        Text(text = "ID: " + student.id.toString())
        Text(text = "Name: " + student.fname + " " + student.lname)
        Text(text = "Country: " + student.country)
    }
}
